    ...
    <div class="card">
        <div class="topbar">
            ...
            <div style="display: flex; gap: 20px; align-items: center;">
                ...
                <a href="logout-simple.php" style="color: #0f0; text-decoration: none;">Tancar Sessio</a>
            </div>
        </div>
        ...
        <div style="margin-top: 2rem; text-align: center;">
            <a href="index-simple.php" style="color: #0f0; text-decoration: none;">Tornar al Inici</a>
        </div>
    </div>
